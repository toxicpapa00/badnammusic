...
class BUTTONS(object):
    MBUTTON = [[InlineKeyboardButton("ᴄʜᴀᴛ-ɢᴘᴛ", callback_data="mplus HELP_ChatGPT"),InlineKeyboardButton("ɢʀσυᴘ", callback_data="mplus HELP_Group"),InlineKeyboardButton("sᴛɪᴄᴋєʀ", callback_data="mplus HELP_Sticker")],
    [InlineKeyboardButton("ᴛᴧɢᴧʟʟ", callback_data="mplus HELP_TagAll"),
    InlineKeyboardButton("ɪηғσ", callback_data="mplus HELP_Info"),InlineKeyboardButton("ᴇxᴛʀᴀ", callback_data="mplus HELP_Extra")],
    [InlineKeyboardButton("ɪᴍᴀɢᴇ", callback_data="mplus HELP_Image"),
    InlineKeyboardButton("ᴧᴄᴛɪση", callback_data="mplus HELP_Action"),InlineKeyboardButton("sᴇᴀʀᴄʜ", callback_data="mplus HELP_Search")],    
