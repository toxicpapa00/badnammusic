...
# Git
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/TEAM-KRITI/Henarobot-")
...
API_KEY = getenv("API_KEY", '30DxNexGenBots39e64f') # youtube song api key, generate free key or buy paid plan from panel.thequickearn.xyz
